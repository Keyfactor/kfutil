...
var (
	sourcePath = flag.String("source", "cmd/pam_types.json", "path to pam_types.json")
	outputDir  = flag.String("out", "docs/use-cases/PAM Operations", "output directory for generated docs")
)
