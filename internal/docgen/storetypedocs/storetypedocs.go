...
const (
	DefaultStoreTypesSource = "cmd/store_types.json"
	DefaultPAMTypesSource   = "cmd/pam_types.json"
	DefaultOutputDir        = "docs/use-cases/Certificate Store Operations/Store Types"
)
...
func Generate(sourcePath, pamPath, outputDir string) error {
	if sourcePath == "" {
		sourcePath = DefaultStoreTypesSource
	}
	if pamPath == "" {
		pamPath = DefaultPAMTypesSource
	}
	if outputDir == "" {
